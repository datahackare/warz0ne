...
By design the script will use thr rockyou wordlist, but you can, if you want to, use what ever wordlist you want. Need some good wordlists? Check out <a href="https://github.com/danielmiessler/SecLists" target="_blank">SecLists</a> or create a custom one for the case.
