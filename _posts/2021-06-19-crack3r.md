...
By design the script will use thr rockyou wordlist, but you can, if you want to, use what ever wordlist you want. The script will open the hashcat examples page when you should input hashtype.<br />
