...
This exploit works better and we got a shell. Whoami show me that i am the root user. With the root-access from the start we can get the root.txt flag and the user.txt flag without futher privesc.
